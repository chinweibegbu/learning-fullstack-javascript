...
const numberMenMedalists = country => {
  return `WITH distinctMenByCountry AS (
      SELECT DISTINCT name 
      FROM GoldMedal 
      WHERE country='${country}' AND gender='Men') 
    SELECT COUNT(*) FROM distinctMenByCountry;`;
};
...
const numberWomenMedalists = country => {
  return `WITH distinctWomenByCountry AS (
      SELECT DISTINCT name 
      FROM GoldMedal 
      WHERE country='${country}' AND gender='Women') 
    SELECT COUNT(*) FROM distinctWomenByCountry;`;
};
